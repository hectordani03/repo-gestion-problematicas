        ...
        <nav>
            <ul className="flex flex-col gap-4 p-4 items-start text-xl mt-8 ml-5">
                <li className="flex items-center gap-4">
                    <Link to="/dashboard" className={`flex items-center gap-4 ${isDark ? 'text-white' : ''}`}>
                ...
                <li className="flex items-center gap-4">
                    <Link to="/request-project" className={`flex items-center gap-4 ${isDark ? 'text-white' : ''}`}>
                ...
                <li className="flex items-center gap-4">
                    <Link to="/explore-projects" className={`flex items-center gap-4 ${isDark ? 'text-white' : ''}`}>
